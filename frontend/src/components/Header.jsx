    ...
    <>
      <header className="flex items-center justify-between px-3 md:px-6 py-3 bg-white shadow-md sticky top-0 z-100">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            className="sm:hidden bg-gray-200 px-4 py-1 rounded-xl"
          ...
          {!user ? (
            ...
            <>
              <span className="flex items-center gap-1 text-sm font-medium text-gray-700 bg-zinc-300 py-1 px-2 md:px-4 rounded">
                <MdAccountCircle className="text-2xl" /> {user.username}
              </span>
              <button
                onClick={logout}
                className="text-sm font-semibold bg-red-500 hover:bg-red-700 text-white px-2 md:px-3 py-1 rounded-md"
              >
                Logout
              </button>
            </>
